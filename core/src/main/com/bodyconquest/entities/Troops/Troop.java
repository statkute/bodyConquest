...
// Temporary implementation to get images for the HUD
    ...
    /**
     * Get the player type to which this unit is assigned.
     *
     ...
     *
     * @param time           the time
     * @param slowPercentage the slow percentage
     */
    ...
    /**
     * method to check whether Troop is ranged.
     *
     * @return true if it is ranged; false otherwise
     */
