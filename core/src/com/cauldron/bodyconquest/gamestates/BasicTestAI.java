...
public class BasicTestAI extends Thread {
  ...
  private void summonWave() {
    Gdx.app.postRunnable(new Runnable() {
      @Override
      public void run() {
        game.spawnUnit(Unit.UnitType.BACTERIA, Lane.BOT, playerType);
        game.spawnUnit(Unit.UnitType.BACTERIA, Lane.MID, playerType);
        game.spawnUnit(Unit.UnitType.BACTERIA, Lane.TOP, playerType);
      }
    });
