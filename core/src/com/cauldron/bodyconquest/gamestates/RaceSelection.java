...
public class RaceSelection implements Screen {
  ...
  private boolean confirmed =
      false; // need to add a button texture so that user could confirm his race
...
//      }
    ...
    game.font.draw(game.batch, "Disease 1", 70, 30);
    game.font.draw(game.batch, "Disease 2", 366, 30);
    game.font.draw(game.batch, "Disease 3", 642, 30);
