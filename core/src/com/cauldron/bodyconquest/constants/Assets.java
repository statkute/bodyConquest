...
public class Assets {
  ...
  public static String mainMenuTitle = "core/assets/title_new_big.png";
  ...
  public static enum PlayerType {
    ...
    public String encoded() {
      switch (this) {
        case PLAYER_BOTTOM:
          return ENCODED_PLAYER_BOTTOM;
        case PLAYER_TOP:
          return ENCODED_PLAYER_TOP;
        case AI:
          return ENCODED_AI;
        default:
          return null;
  ...
  public enum Lane {
    ...
    public String encoded() {
      switch (this) {
        case BOTTOM:
          return BOTTOM_ENCODED;
        case MIDDLE:
          return MIDDLE_ENCODED;
        case TOP:
          return TOP_ENCODED;
        case ALL:
          return ALL_ENCODED;
