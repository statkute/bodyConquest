...
public class Assets {
    ...
    /**
     * The constant raceYellowVirusNoBorder.
     */
    ...
    /**
     * The constant frameColsBacteria.
     */
    public static int frameColsBacteria = 2;//7;
    /**
     * The constant frameRowsBacteria.
     */
    public static int frameRowsBacteria = 11;//1;
    /**
     * The constant frameColsFlu.
     */
    public static int frameColsFlu = 4;//7;
    /**
     * The constant frameRowsFlu.
     */
    public static int frameRowsFlu = 4;//1;
    /**
     * The constant frameColsVirus.
     */
    public static int frameColsVirus = 4;//7;
    /**
     * The constant frameRowsVirus.
     */
    public static int frameRowsVirus = 2;//1;
    /**
     * The constant frameColsProjectile.
     */
    public static int frameColsProjectile = 5;//6;
    /**
     * The constant frameRowsProjectile.
     */
...
// Spawnpoint coords for TOP player
    ...
    /**
     * The constant TP_MID_LANE_SPAWN_Y.
     */
    ...
    /**
     * The Mid lane tp spawn x.
     */
// Not yet initialised
    public float midLaneTPSpawnX;
    /**
     * The Top lane tp spawn x.
     */
    public float topLaneTPSpawnX = 175;
    /**
     * The Mid lane tp spawn y.
     */
    public float midLaneTPSpawnY;
    /**
     * The Top lane tp spawn y.
     */
    public float topLaneTPSpawnY = 525;

    /**
     * The constant buttonSoundPath.
     */
//Sounds
