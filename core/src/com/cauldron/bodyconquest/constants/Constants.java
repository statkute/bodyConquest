...
public class Constants {
    ...
    public static final float BOT_TURNPOINT_Y = 60;
    ...
    public static final float BP_BOT_LANE_SPAWN_Y = 85; // 90;
    public static final float BP_MID_LANE_SPAWN_X = 505;
    public static final float BP_MID_LANE_SPAWN_Y = 185;
    public static final float BP_TOP_LANE_SPAWN_X = 600;
    ...
    public static final float TP_MID_LANE_SPAWN_X = 505; //TODO REST v
    public static final float TP_MID_LANE_SPAWN_Y = 185;
    public static final float TP_TOP_LANE_SPAWN_X = 600;
    public static final float TP_TOP_LANE_SPAWN_Y = 225;
